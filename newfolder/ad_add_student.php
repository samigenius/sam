			...
			<div id="content-wrap">
                <div id="main">
					<?php echo $_SESSION['Msg']; ?>
							...
							<form method="post" action="ad_add_student.php">
...
$sql=mysqli_query($con, "INSERT INTO student VALUES('$stuid', '$stuname', '$batchno', '$batchcatagory', '$time', '$stucontact', '$stuemail')");
