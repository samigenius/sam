        ...
        <div id="wrap">
			...
			<div id="content-wrap">
                <div id="main">
					...
					<form action="ad_employee_attendance_report.php" method="post">
					...
					<table id="t01">
					  <tr>
						...
						{		
						$sql = mysqli_query($con, "SELECT empcheckin.Date, empcheckin.EntryTime, empcheckin.EntryStatus, empcheckout.ExitTime, empcheckout.ExitStatus FROM empcheckin INNER JOIN empcheckout ON empcheckin.EmpID=empcheckout.EmpID WHERE EmpID Like '%$term%'") 
						or die(mysql_error());
						...
						$sql = mysqli_query($con, "SELECT empcheckin.Date, empcheckin.EntryTime, empcheckin.EntryStatus, empcheckout.ExitTime, empcheckout.ExitStatus FROM empcheckin INNER JOIN empcheckout ON empcheckin.EmpID=empcheckout.EmpID") 
						or die(mysql_error());
